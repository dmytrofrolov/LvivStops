...
public class OneTransportStopListActivity extends AppCompatActivity {
        ...
        textEdit.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                if (stopItemArrayList.size() > 0)
                    stopsList.setAdapter(new StopAdapter(OneTransportStopListActivity.this, array_sort));
            }
        });
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            case R.id.saved_stops:
                Intent appInfo = new Intent(OneTransportStopListActivity.this, SavedStopsActivity.class);
                startActivity(appInfo);
                return true;
